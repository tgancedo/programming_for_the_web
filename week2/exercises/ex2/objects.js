const games = [
  ...
  { title: 'Connect Four', type: 'board', numberOfPlayers: '2', rating: '5/10', shortDescription: 'take turns dropping checkers in a vertical grid to connect 4 in a row.' },
  { title: 'Hungry Hungry Hippos', type: 'board', numberOfPlayers: '4', rating: '4/10', shortDescription: 'furiously push hungry hippo’s tails a million times to eat the most marbles.' },
