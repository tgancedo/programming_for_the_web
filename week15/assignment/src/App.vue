...
let cameras = 
      [{
        image: "src/assets/p-104.jpg",
        name: "Polaroid Land Model 104",
        released: "1965",
        rarity: "common",
        filmType: "100 Series Pack Film",
        collected: true,
        sound: "src/assets/audio/demo.mp3",
        id: 0
      }, {
        image: "src/assets/p-swinger.jpg",
        name: "Polaroid Swinger Model 20",
        released: "1965",
        rarity: "very common",
        filmType: "20 Series Roll Film",
        collected: true,
        sound: "src/assets/audio/phone.mp3",
        id: 1
      }, {
        image: "src/assets/p-onestep.jpg",
        ...
        image: "src/assets/instamatic.jpg",
        ...
        image: "src/assets/teleinstamatic.jpg",
    ...
    <form v-on:submit.prevent="addNewCamera" class="new-camera-form">
      <fieldset>
        ...
        <div>
          ...
          <input id="film" type="text" v-model="newCameraObj.filmType">
        </div>
        <div>
...
(min-device-width: 768px) and (max-device-width: 1024px)  {
  ...
  width: 100%;
	...
	*/
	...
	td:nth-of-type(6):before { content: "Collected"; }
